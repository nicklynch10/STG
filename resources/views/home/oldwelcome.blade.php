...
<body>
<div class="fake_body">
{{-- mdl-layout mdl-js-layout mdl-layout--fixed-header has-drawer is-upgraded --}}
  <header class="mdl-layout__header--transparent mdl-color--light-blue-300 mdl-shadow--2dp mdl-layout--fixed-header">
    <div class="mdl-layout__header-row">
      <!-- Title -->
      {{-- <span class="mdl-layout-title" style="line-height: 28px;"> Swing Tips Golf
            <div style="font-size: 14px; text-align: center;">
            perfect the experience
            </div></span> --}}

            <a style="text-shadow:0px 0px 1px #262D2E; color:#090A0A; font-size: 35px; line-height: 28px;" class="mdl-navigation__link  custom_title" href="{{url('/welcome')}}">
            Swing Tips Golf
            <div style="font-size: 14px; text-align: center;">
            perfect the experience
            </div>
    ...
    <a class="mdl-navigation__link" href="{{ url('/about') }}">About Swing Tips Golf</a>
     <a class="mdl-navigation__link" href="{{ url('/how') }}">How to Use Swing Tips Golf</a>
    <a class="mdl-navigation__link" href="{{ url('/apply') }}">Become a SwingTip Pro</a>
    <a class="mdl-navigation__link" href="{{ url('/register') }}">Create Account</a>
