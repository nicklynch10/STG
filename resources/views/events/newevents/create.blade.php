...
<form class="mdl-cell mdl-cell--12-col mdl-shadow--2dp mdl-color--white" method="POST" action="{{url('/newevent/save')}}">
 {{ csrf_field() }}
	...
	<div style="font-size:25px; line-height: 35px; width: 100%; " class="mdl-color-text--light-blue-300">
        ...
        <input class="mdl-textfield__input"  value='{{$temp->title or "New Event"}}' type="text" name="title" id="title" style="height: 50px;font-size: 35px; text-align: center;">
	...
	<div class="row">
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="min-width: 270px; width: 50%; ">
        <input class="mdl-textfield__input"  value="{{$temp->location or Auth::user()->address}}" type="text" name="location" id="location" style="text-align: center;">
	...
	<div class="attr">Student Email (if applicable):
	 ...
	 <div class="row">
        ...
        @if($temp->student_email) value="{{$temp->student_email}}" @endif>
    ...
    <textarea style="width:100%; min-height:110px;" class="mdl-textfield__input" name="notes" type="text" id="notes" >{{$temp->notes}}</textarea>
...
<div class="button_container mdl-cell--12-col">
	...
	<a class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--red-400 event_button" href="{{url('/calander')}}"> Cancel </a>
