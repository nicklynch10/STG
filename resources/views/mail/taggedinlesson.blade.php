                                ...
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        ...
                                        <!-- Intro -->
                                                ...
                                                {{$pro->morphname()}} has tagged you in a lesson.
                                                 Swing Tips Golf is a platform pros can use to manage their lessons and much more.
                                                 Please create an account to interact with {{$pro->morphname()}}
                                            </p>
                                             <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                             {{$event->title}}<br>
                                                Lesson Time: {{$event->display_start}} to {{$event->display_end}}<br>
                                                Location: {{$event->address}} {{$event->location}}<br>
                                                Notes: {{$event->notes}}
                                        ...
                                        <!-- Action Button -->
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <a href="https://swingtipsgolf.com/login"
                                        ...
                                        <!-- Sub Copy -->
                                                ...
                                                <tr>
                                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif;">
                                                        ...
                                                        <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                            <a style="color: #3869D4;" href="https://swingtipsgolf.com/login" target="_blank">
                                                                https://swingtipsgolf.com/login
                                                            </a>
                                                        </p>
                                                    </td>
                                                </tr>
