                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="padding: 25px 0; text-align: center;">
                                <a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="http://swingtipsgolf.com/login" target="_blank">
                                    Swing Tips Golf
                                </a>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                            ...
                                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                                {{$other->morphname()}} has tagged you in a lesson with {{$pro->morphname()}}.
                                                Swing Tips Golf is a platform pros can use to manage there lessons and much more.
                                                Please create an account to interact with {{$pro->morphname()}}
                                            </p>
                                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                            ...
                                            <table style="width: 100%; margin: 30px auto; padding: 0; text-align: center;" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <a href="https://swingtipsgolf.com/pro/signup/{{$pro->id}}"
                                                            ...
                                                            class="button"
                                                            target="_blank">
                                                            Sign up and view to {{$pro->morphname()}}'s Locker!
                                                        </a>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <!-- Outro -->
                                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                                Thank you for using Swing Tips Golf
                                            </p>
                                            
                                            <!-- Salutation -->
                                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                                Regards,<br>Swing Tips Golf
                                            </p>
                                            <!-- Sub Copy -->
                                                ...
                                                <tr>
                                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif;">
                                                        <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                            If you’re having trouble clicking the "Respond To Request" button,
                                                            copy and paste the URL below into your web browser:
                                                        </p>
                                                        <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                            <a style="color: #3869D4;" href="https://swingtipsgolf.com/pro/signup/{{$pro->id}}" target="_blank">
                                                                https://swingtipsgolf.com/pro/signup/{{$pro->id}}
                                                            </a>
                                                        </p>
                                                    </td>
                                                </tr>
                                ...
                                <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0; text-align: center;" align="center" width="570" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                            <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                &copy; 2017
                                                <a style="color: #3869D4;" href="http://localhost:8000" target="_blank">Swing Tips Golf</a>.
                                                All rights reserved.
                                            </p>
                                        </td>
                                    </tr>
